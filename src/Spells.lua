...
spell_builder
    ...
    .source(FLAG_H_PLR).build("Battle Stance", CAST_SCS)
    .source(FLAG_H_PLR).build("Berserker Rage", AURA_APP)
    .source(FLAG_H_PLR).build("Berserker Stance", CAST_SCS)
	...
	.source(FLAG_H_PLR).build("Defensive Stance", CAST_SCS)
	...
	.source(FLAG_H_PLR).build("Enrage", AURA_APP)  
	...
	.source(FLAG_H_PLR).build("Nature's Swiftness", AURA_APP)
    ...
    .source(FLAG_H_PLR).spell("Prowl").sound("Stealth").build("Prowl", CAST_SCS)
